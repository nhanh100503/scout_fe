<template>
    <div class="flex flex-col h-full overflow-y-auto">
        <div class="max-w-4xl mx-auto w-full p-6 flex-1 flex flex-col">
            <h2 class="text-xl font-semibold mb-4 text-emerald-700">Thông tin huynh trưởng</h2>
                ...
                <div class="flex-1 overflow-y-auto space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input :value="member.identify" type="text"
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                        <div>
            ...
            <div v-else class="text-center text-gray-500">Không tìm thấy thông tin huynh trưởng</div>
        </div>
    </div>
</template>
