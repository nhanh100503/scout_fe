<template>
    <div class="flex flex-col h-full overflow-y-auto">
        <div class="max-w-4xl mx-auto w-full p-6 flex-1 flex flex-col">
            <h2 class="text-xl font-semibold mb-4 text-emerald-700">Thông tin đạo trưởng</h2>
            ...
            <div v-else-if="member" class="space-y-4 flex-1 flex flex-col">
                <div class="flex-1 overflow-y-auto space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" :value="member.team?.name" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input :value="member.placeOfBirth" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input :value="member.identify" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Email *</label>
                            <input :value="member.email" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input :value="member.phone" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Địa chỉ *</label>
                            <input :value="member.address" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input :value="member.career" type="text" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-4 mt-2">
                                <label v-for="item in member.majors" :key="item.majorId">
                                    <input disabled type="checkbox" :value="item.majorId" checked />
                                    {{ item.name }}
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" :value="member.otherResponsibility" readonly
                                class="mt-1 w-full border rounded-md px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div>
                ...
                <div class="pt-4">
                    <router-link :to="`/members/update/dt/${member.memberId}`"
